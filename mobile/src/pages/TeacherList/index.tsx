...
const TeacherList: React.FC = () => {
  ...
  return (
    <Container>
      <PageHeader title="Tutors disponíveis">
        <FilterButton onPress={handleFilterButtonClick}>
          <Image source={filterIcon} />
          <FilterButtonText>Filtrar por dia, hora e disciplina</FilterButtonText>
