...
import backgroundImage from '../../assets/images/backgroundStudy.png';
...
const Landing = () => {
  ...
  useEffect(()=> {
    async function firtVisit() {
      await AsyncStorage.setItem('@TutorUp:firstVisit', String(true));
    }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>
          Encontre professores e entre em contacto
        </Text>
